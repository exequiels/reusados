...
<table class="table table-sm table-bordered border-estilo">
    ...
    <tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=inicio">Inicio</a></td>
    </tr>
    <tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=buscador">Buscador</a></td>
    </tr>
    <tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=tendencias">Tendencias</a></td>
    </tr>
    <!--<tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=foro">Foro</a></td>
    </tr>-->
</table>
<!-- // Menu -->
...
<!-- <table class="table table-sm table-bordered border-estilo">
    ...
    <tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=mi-perfil">Mi perfil</a></td>
    </tr>
    <tr class="p-3 menu-item">
        <td class="py-3 px-3"><a href="?dir=tendencias">LogOff</a></td>
    </tr>
</table> -->
<!-- Menu perfil -->