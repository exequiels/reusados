...
class VideoGameModel
{
    ...
    public function getSubcategorias($pais, $categoria)
    {
        try {
            $tabla = $pais . "_" . $categoria . "_principal";
    ...
    public function getAllVideoGamesMask($filters, $page = 1, $perPage = 15)
    {
        try {
    ...
    public function countVideoGamesMask($filters)
    {
        try {
