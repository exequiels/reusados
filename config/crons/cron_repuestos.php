...
$logFile = __DIR__ . '/cron_repuestos.txt';
...
if ($pdo) {
    ...
    if (!$updateStmt->execute([':source' => 'repuestos'])) {
...
function extraerDatos($pdo, $SITE_ID, $ACCESS_TOKEN, $searchTerms)
{
    ...
    if ($pdo) {
        ...
        $deleteStmt->execute([':source' => 'repuestos']);
...
$searchTerms = [
    'MLA43857' => ['nintendo nes', 'super nintendo', 'nintendo 64', 'gamecube', 'sega genesis', 'sega saturn', 'sega dreamcast', 'playstation 1', 'playstation 2', 'playstation 3'],
];
