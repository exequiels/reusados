...
$totalGames = $videoGameModel->countVideoGamesMask($filters);
$totalPages = ceil($totalGames / $perPage);

$allData = $videoGameModel->getAllVideoGamesMask($filters, $page, $perPage);
        ...
        <tr>
            ...
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                ...
                <img src="assets/imgs/oraculo.png" 
                    class="img-fluid border border-dark mt-3 mt-md-0" 
                    width="120" height="120" 
                    rel="noopener noreferrer nofollow" 
                    alt="La mascara de Go...">
                </div>
            </td>
        </tr>
    </thead>
    ...
    ?>
                        ...
                        <div class="col-12 mb-2 mt-2">
                            <div class="user-card p-3 border border-dark d-flex flex-column">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                                    <img src="assets/imgs/stadio.webp" 
                                        class="img-fluid mb-3 mb-md-0 me-md-3 border border-dark" 
                                        width="120" height="120" 
                                        rel="noopener noreferrer nofollow" 
                                        alt="">
                                    ...
                                    <div class="user-info text-start flex-grow-1">
                                        <div class="username mb-2">
                                            Cassete viejo de video juego Nintendo Stadio
                                        </div>
                                        <div class="details">
                                            <p class="mb-1 blur-text-s text-success">$15000</p>
                                            <p class="mb-1 blur-text-m text-success">Envio gratis</p>
                                            <p class="mb-1 blur-text">Usado</p>
                                        </div>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-end mt-auto">
                                    <img src="assets/imgs/cofre.png" class="blur-text" width="55px" alt="Cofre" id="cofre">
                                </div>
                            </div>
                        </div>
