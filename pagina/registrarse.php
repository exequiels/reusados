...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) {
            ...
            $stmt = $pdo->prepare("INSERT INTO usuarios (username, fullname, email, password, created_at) VALUES (?, ?, ?, ?, NOW())");
        ...
        <td class="p-3" colspan="2">
            <form role="form" id="registro" action="" method="post">                
                <div class="form-group mt-3">
                    ...
                    <input type="text" id="username" name="username" placeholder="Nickname en reUsados" minlength="3" maxlength="30" class="w-100" required>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" id="fullname" name="fullname" placeholder="Tu nombre" minlength="3" maxlength="30" class="w-100" required>
                    <span class="validacion text-danger" style="display: none;">Algo no cuadra.</span>
                </div>            
                <div class="form-group mt-3">
                    <label for="email">Correo electrónico:</label>
                    <span class="text-body-tertiary">(un email válido)</span>
                    <input type="email" id="email" name="email" placeholder="Email" minlength="8" maxlength="50" class="w-100" required>
